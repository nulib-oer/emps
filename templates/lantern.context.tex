...
$description$
\blank
\copyright $publication-year$ $if(copyright.holder)$$copyright.holder$$else$$for(author)$$author.name$$sep$, $endfor$$endif$ All rights reserved.
\blank
$if(copyright.license)$
Licensed under \goto{$copyright.license$}[url($copyright.license-uri$)]
$endif$
\blank
$if(publisher)$
