...
This problem is also referred to as **omitted variable bias**. You will learn this in more detail in the chapter on "Large N", but the idea is that you always risk leaving out variables that are key to explaining the causal relationship, and this can affect your interpretation of results.
